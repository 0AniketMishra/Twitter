    ...
    <div className='flex space-x-2 p-5 mr-5  mt-8 border-b-2 border-gray-200' >
        ...
        <div className='flex flex-1 items-center pl-2'>
            <form action="" className='flex flex-1 flex-col'>
              ...
              <svg onClick={() => setImageUrlBoxIsOpen(!imageUrlBoxIsOpen)} xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:cursor-pointer " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
